...
CC = gcc
CXX = g++
CCFLAGS += -fPIC -pipe -W -Wall -Wpointer-arith -Wno-unused-parameter -DNDK_SET_VAR -Wno-unused-function -Wno-missing-field-initializers -D_POSIX_C_SOURCE=200112L -DNDK_SET_VAR
...
clean:	
	rm -rf objs *.out cscope.files GRTAGS GTAGS GPATH *.so
